...
import com.example.sibiko.DataPelanggaranActivity;
...
public class AdapterSiswaPelanggaran extends RecyclerView.Adapter<AdapterSiswaPelanggaran.ViewHoler>{

    private List<Siswa> siswas;
    Context context;

    public AdapterSiswaPelanggaran(List<Siswa> siswas, Context context) {
        this.siswas = siswas;
    ...
    public void onBindViewHolder(@NonNull ViewHoler holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentSiswa = new Intent(context, DataPelanggaranActivity.class);
